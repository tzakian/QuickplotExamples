...
trace (x,y) sizes (text, country) = [plotly|{
  x : #{ x },
  y : #{ y },
  type : "scatter",
  mode : "markers",
...
main = do
   ...
   let traces = zipWith3 trace dat sizes (zip texts countries)
   -- with layout
   plot traces
   -- without layout
   plot (traces, layout)
...
dat :: [([Double], [Double])]
dat = [
  ([6223.367465, 4797.231267, 1441.284873, 12569.851770000001, 1217.032994,
    ...
    [72.301, 42.731, 56.728, 50.728, 52.295, 49.58, 50.43, 44.74100000000001,
    ...
    43.486999999999995]),
  ([12779.379640000001, 3822.1370840000004, 9065.800825, 36319.235010000004,
    ...
    [75.32, 65.554, 72.39, 80.653, 78.553, 72.889, 78.782, 78.273, 72.235,
  ...
  ([974.5803384, 29796.048339999998, 1391.253792, 1713.7786859999999,
    ...
    2280.769906],
    [43.828, 75.635, 64.062, 59.723, 72.961, 82.208, 64.69800000000001,
  ...
  ([5937.029525999999, 36126.4927, 33692.60508, 7446.298803, 10680.79282,
    ...
    [76.423, 79.829, 79.441, 74.852, 73.005, 75.748, 76.486, 78.332, 79.313,
    ...
    ([34435.367439999995, 25185.00911],
     [81.235, 80.204])
  ]

sizes :: [[Double]]
sizes = [
  [29.810746602820924, 18.197149567147044, 14.675557544415877,
  ...
  [21.94976988499517, 10.441052822396196, 47.66021903725089,
  ...
  [9.330561207739747, 1.390827697025556, 20.266312242166443,
  ...
  [12.542029402681376, 18.92719251331642, 21.30783431755826,
